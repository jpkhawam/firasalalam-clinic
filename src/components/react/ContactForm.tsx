        ...
        <div>
          ...
          <div className="mt-4">
            <button
              ...
              id="submit-button"
            >
              <span className="inset-0 inline-block border-2 border-black bg-black px-8 py-3 text-sm [font-weight:800;] uppercase tracking-widest text-white transition-transform group-hover:bg-white group-hover:text-black">
                Submit
              </span>
            </button>
          </div>
